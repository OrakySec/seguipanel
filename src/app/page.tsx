...
function MobileStickyCta() {
  return (
    <div className="fixed bottom-4 left-4 right-4 z-40 sm:hidden" aria-hidden>
      <Link
        href="/comprar-seguidores-instagram"
        className="flex items-center justify-center w-full py-4 text-sm font-bold text-white rounded-full bg-brand-gradient shadow-lg hover:opacity-90 transition-opacity gap-2"
      >
        <Zap size={16} />
        50% OFF — Comprar Seguidores Agora
      </Link>
    </div>
  );
}
