    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        ...
        <h2 className="text-xl font-extrabold text-gray-900 mb-2 leading-tight">
          Você ganhou bônus em todos os seus pedidos!
        </h2>
        <p className="text-sm text-gray-500 mb-6 leading-relaxed">
          Receba <strong className="text-gray-800">+30% a mais</strong> neste pacote e em{" "}
          <strong className="text-gray-800">todas as suas compras futuras</strong>. Resgate agora pelo WhatsApp.
        </p>
